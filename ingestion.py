...
doc = Document(
    page_content="text", metadata={"source": "local"}
...
vectorstore_final.delete(
    [vectorstore_final.index_to_docstore_id[0]]
)  # delete the initial empty document
vectorstore_final.save_local(
    "./faiss-index-" + str(chunk_size) + "-" + str(chunk_overlap)
)
